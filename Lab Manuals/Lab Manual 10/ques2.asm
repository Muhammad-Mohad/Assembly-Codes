...
clr:
    ...
    mov es, ax
    mov di, 0               ; Starting position in video memory
    mov cx, 2000            ; 2000 words to clear (80x25 screen)
    mov ax, 0x0720          ; Space character with attribute (white on black)

l1:
    mov [es:di], ax         ; Write space to video memory
